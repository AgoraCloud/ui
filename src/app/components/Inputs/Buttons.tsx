...
export const BaseFAB = (props: { onClick: () => any; children: React.ReactElement }) => {
...
export const CancelCreateButtons = observer(
  (props: { form: BaseFormModel<any, any>; cancel: () => any; submit: () => any }) => {
...
export const MoreMenu = (props: { options: { name: string; onClick: () => any }[] }) => {
  const { options } = props;
