...
export const WorkspacesLoaded = inject(WORKSPACES_STORE, ROUTER_STORE)(observer((props) => {
...
export const DeploymentLoaded = inject(WORKSPACES_STORE, ROUTER_STORE)(observer((props)=>{
    const store = props[WORKSPACES_STORE] as WorkspacesStore
    const routerStore = props[ROUTER_STORE] as RouterStore
...
export const ProjectsLoaded = inject(WORKSPACES_STORE, ROUTER_STORE)(observer((props)=>{
    const store = props[WORKSPACES_STORE] as WorkspacesStore
    const routerStore = props[ROUTER_STORE] as RouterStore
    const workspace = store.selectedWorkspace
...
export const LanesLoaded = inject(WORKSPACES_STORE, ROUTER_STORE)(observer((props)=>{
    const store = props[WORKSPACES_STORE] as WorkspacesStore
    const routerStore = props[ROUTER_STORE] as RouterStore
    const workspace = store.selectedWorkspace
