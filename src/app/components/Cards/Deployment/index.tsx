...
export const DeploymentChip = (props: { deployment: Deployment }) => {
  const { deployment } = props;
  return <div style={{ paddingTop: "15px" }}>{chips[deployment.status] || null}</div>;
};

export const DeploymentLaunch = (props: { deployment: Deployment }) => {
  const { deployment } = props;
  return (
    <LinkButton
      variant="contained"
...
export const DeploymentResources = (props: { deployment: Deployment }) => {
  const { deployment } = props;
...
export const DeploymentMenu = inject(ROUTER_STORE)(
  observer((props: { deployment: Deployment }) => {
    const { deployment } = props;
...
export const DeploymentCard = (props: { deployment: Deployment }) => {
  const { deployment } = props;
  return (
    <Card
      style={{
