...
import { UserModel } from 'app/workspace/user/models';
...
export class UpdateUserFormModel extends BaseFormModel<
  updateUser_i,
  updateUser_i
> {
...
export class AdminUpdateUserFormModel extends BaseFormModel<
  adminUpdateUser_i,
  adminUpdateUser_i
> {
  constructor(public user: UserModel) {
