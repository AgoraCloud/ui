...
import { WikiSectionModel, WikiPageModel } from 'app/workspace/wiki';
import { ContextMenu } from 'app/components/inputs/context-menu';
...
export const PageButton = inject(UI_STORE)(
  observer((props: { page: WikiPageModel }) => {
    const { page } = props;
    ...
    const menuItems = [
      {
        label: 'Delete',
        onClick: () => {
          store.setDeleteTarget(page.title, page.delete);
        },
      },
    ];
...
export const WikiList = inject(WORKSPACES_STORE)(
  observer((props) => {
        ...
        <div className={style.topsidebar}>
          <ListItem>
            ...
            >
              <IconButton
                color="primary"
                disabled={selectedWiki == undefined}
                onClick={() => {
