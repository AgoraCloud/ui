...
import { CreateProjectTaskDto, UpdateProjectTaskDto, UpdateProjectTaskLaneDto } from 'app/forms/validators';
...
export class CreateTaskFormModel extends BaseFormModel<createTaskForm_i, createTaskForm_i>{
...
export class EditTaskFormModel extends BaseFormModel<updateLaneForm_i, updateLaneForm_i>{
