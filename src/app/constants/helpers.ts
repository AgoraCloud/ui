...
export const update = <DataT, BodyT>(model: Model<DataT, any, any>, repos: BaseRepo<DataT, any> | BaseRepo<DataT, any>[]) => {
...
export const add = <DataT>(collection: CollectionModel, repo: BaseRepo<DataT>) => {
  repo.onLoad.subscribe(() => {
