...
import { InWorkspaceActions, InWorkspaceRole, WorkspaceActions } from "app/constants";
...
export class AdminStore{    
    ...
    constructor(public rootStore: RootStore){
        ...
        this.permissionsDialog = new PermissionsDialogModel(WorkspaceActions, InWorkspaceRole)
