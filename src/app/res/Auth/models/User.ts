...
import { AdminDeleteUserFormModel, AdminUpdateUserFormModel, UserPermissionsModel } from "app/res/Admin";
import {
...
export class AdminUserModel extends BaseAdminUserModel<adminUserModel_i> {
    ...
    constructor({ parent, data }) {
        ...
        this.unverify = new APIRepo({ path: this.api, data: { isVerified: false } })
