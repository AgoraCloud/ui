...
export const FilterSelect = ({ options, label, onSearch }: { 
...
export const AuditLogTable = observer(({auditLogs} : {auditLogs: BaseAuditLogs}) => {
        ...
        <Table stickyHeader aria-label="sticky table">
          <TableHead>
            <TableRow>
              ...
              // style={{ minWidth: column.minWidth }}
              >
                <FilterSelect label='Resource' options={resources} onSearch={addQuery('resource')} />
              </TableCell>
              <TableCell
                key={'action'}
              // align={column.align}
              // style={{ minWidth: column.minWidth }}
              >
                <FilterSelect label='Action' options={actions} onSearch={addQuery('action')} />
              </TableCell>
              <TableCell
                key={'username'}
              // align={column.align}
...
const actions = [
  'CREATE', 'READ', 'READ_IMAGES', 'READ_LOGS', 'READ_METRICS', 'PROXY', 'UPDATE', 'DELETE', 'LOG_IN', 'LOG_OUT', 'READ_USERS', 'ADD_USER', 'REMOVE_USER', 'TURN_ON', 'TURN_OFF'
]

const resources = [
  'USER', 'PERMISSION', 'AUDIT_LOG', 'WORKSPACE', 'DEPLOYMENT', 'PROJECT', 'PROJECT_LANE', 'PROJECT_TASK', 'WIKI_SECTION', 'WIKI_PAGE', 'SHORTCUT'
]