...
export const DeploymentsAccordion = observer(({ deployments, summary }: { deployments: DeploymentModel[], summary: string}) => {
...
export const DeploymentsList = observer(
  ({ workspace }: { workspace: WorkspaceModel }) => {
    ...
    const notfavorited = deployments.filter((deployment) => !deployment.isFavorite)
    console.log(favorited, notfavorited)
    return (
      <>
        <DeploymentsAccordion summary="Favorited Deployments" deployments={favorited}/>
        <DeploymentsAccordion summary="Deployments" deployments={notfavorited}/>
      </>
