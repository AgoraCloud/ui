...
export const CreateDeploymentForm = observer((props: { form: CreateDeploymentFormModel }) => {
    ...
    return (
        <div>
            ...
            <Input form={form} id="name" label="deployment name" autoComplete="off" />
...
export const EditDeploymentForm = observer((props: { form: EditDeploymentFormModel }) => {
