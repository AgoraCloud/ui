...
import {
  ...
  EditDeploymentForm,
} from "app/components/Forms/Workspace/Deployments";
import { Typography } from "@material-ui/core";

export const CreateDeployment = inject(WORKSPACES_STORE)(
  observer((props) => {
...
export const EditDeployment = inject(WORKSPACES_STORE)(
  observer((props) => {
    const store = props[WORKSPACES_STORE] as WorkspacesStore;
