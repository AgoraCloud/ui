...
export const UsersTable = observer((props: { adminStore: WorkspaceAdminStore }) => {
...
export const WorkspaceAdminUsersPage = inject(WORKSPACES_STORE)(observer((props) => {
    ...
    return <div>
        ...
        <InviteUserDialog form={workspaceAdminStore.inviteUserForm} dialog={workspaceAdminStore.inviteUserDialog}/>
