...
export const ProjectList = inject(WORKSPACES_STORE, ROUTER_STORE, UI_STORE)(observer((props) => {
  ...
  projects.forEach((project) => (
    rows.push({
      id: project.data.id, name: <Link href={"/w/"+ workspace.id + "/p/"+ project.id +"/lanes"} color="inherit"> {project.data.name} </Link>, description: project.data.description, edit: <MoreMenu options={[
        {
          name: "Edit",
          onClick: () => {
