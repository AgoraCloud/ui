...
export const WorkspaceAlert = (props: {metrics: WorkspaceMetrics}) => {
    const {metrics} = props
    if(metrics.status === 400) return <Alert severity="error">This workspace has no configured resource limitations!</Alert>
    return null
}

export const WorkspaceMetricsPage = inject(WORKSPACES_STORE)(observer((props) => {
