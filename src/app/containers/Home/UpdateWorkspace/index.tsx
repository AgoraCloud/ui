    ...
    return (
      <HomeWrapper>
        ...
        <TextField
          ...
          error={
            form.getError('properties.resources.cpuCount') != undefined &&
            String(val.properties.resources.cpuCount) != ''
          }
          helperText={
            String(val.properties.resources.cpuCount) != ''
              ? form.getError('properties.resources.cpuCount')
              : undefined
        ...
        <TextField
          ...
          error={
            form.getError('properties.resources.memoryCount') != undefined &&
            String(val.properties.resources.memoryCount) != ''
          }
          helperText={
            String(val.properties.resources.memoryCount) != ''
              ? form.getError('properties.resources.memoryCount')
              : undefined
          } // to be implemented (currently all errors are just 'error')
        ...
        <TextField
          ...
          error={
            form.getError('properties.resources.storageCount') != undefined &&
            String(val.properties.resources.storageCount) != ''
          }
          helperText={
            String(val.properties.resources.storageCount) != ''
              ? form.getError('properties.resources.storageCount')
              : undefined
          } // to be implemented (currently all errors are just 'error')
